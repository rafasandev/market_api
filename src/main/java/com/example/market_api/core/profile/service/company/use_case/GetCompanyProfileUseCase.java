...
public class GetCompanyProfileUseCase {
        ...
        return companies.stream()
                .map(company -> {
                    return profileMapper.toResponseDto(
                            company,
                            contactInfoMapper.mapContactInfos(company.getUser().getContacts()));
                })
                .toList();
    }
    ...
    public CompanyProfileResponseDto getCompanyById(UUID id) {
        ...
        return profileMapper.toResponseDto(company, contactInfoMapper.mapContactInfos(company.getUser().getContacts()));
    }
